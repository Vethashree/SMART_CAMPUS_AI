import { Student, Subject, Achievement, Timetable, DaySchedule, TimeSlot } from '../types/Student';

// Generate sample attendance data
const generateAttendanceData = (subjectCode: string): any[] => {
  const records = [];
...
const calculateAttendancePercentage = (records: any[]): number => {
